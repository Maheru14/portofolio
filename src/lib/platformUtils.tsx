...
export const platformColors: Record<string, string> = {
  github: 'hover:border-slate-400 hover:text-slate-900',
  email: 'hover:border-slate-400 hover:text-slate-900',
  linkedin: 'hover:border-slate-400 hover:text-slate-900',
  instagram: 'hover:border-slate-400 hover:text-slate-900',
};
...
export function getPlatformColor(platform: string) {
  return platformColors[platform] || 'hover:border-slate-400 hover:text-slate-900';
}
